use crate::{
    AsMutRawCharSlice, AsRawCharSlice, AsRawParts, Attribute, GetAttr, SetAttr, SQLINTEGER,
    SQLPOINTER, SQLUINTEGER,
};
use rs_odbc_derive::{AnsiType, ConnAttr, EqSQLUINTEGER, UnicodeType};
...
impl<T: AsMutRawCharSlice<SQLINTEGER>> GetAttr<T> for SQL_ATTR_CURRENT_CATALOG {}
impl<T: AsRawCharSlice<SQLINTEGER>> SetAttr<T> for SQL_ATTR_CURRENT_CATALOG {}
...
impl<T: AsMutRawCharSlice<SQLINTEGER>> GetAttr<T> for SQL_ATTR_TRACEFILE {}
impl<T: AsRawCharSlice<SQLINTEGER>> SetAttr<T> for SQL_ATTR_TRACEFILE {}
...
// TODO: Has to be null-terminated
impl<T: AsMutRawCharSlice<SQLINTEGER>> GetAttr<T> for SQL_ATTR_TRANSLATE_LIB {}
impl<T: AsRawCharSlice<SQLINTEGER>> SetAttr<T> for SQL_ATTR_TRANSLATE_LIB {}
