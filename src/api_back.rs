use crate::{
    CTypeIdentifier, ConnAttr, DescFieldIdentifier, DiagIdentifier, HandleType, SqlColAttr,
    StmtAttr,
};

use crate::{
    RETCODE, SQLCHAR, SQLHANDLE, SQLHDBC, SQLHDESC, SQLHENV, SQLHSTMT, SQLHWND, SQLINTEGER, SQLLEN,
    SQLPOINTER, SQLRETURN, SQLSETPOSIROW, SQLSMALLINT, SQLULEN, SQLUSMALLINT, SQLWCHAR,
};

#[allow(non_snake_case)]
// TODO: Should extern C be used instead?
extern "system" {
    fn GetDiagFieldA(
        HandleType: HandleType,
        Handle: SQLHANDLE,
        RecNumber: SQLSMALLINT,
        DiagIdentifier: SQLINTEGER,
    ...
    pub fn SQLBrowseConnectA(
        ...
        InConnectionString: *mut SQLCHAR,
    ...
    pub fn SQLBrowseConnectW(
        ConnectionHandle: SQLHDBC,
        // _In_reads_(StringLength1)
        InConnectionString: *mut SQLWCHAR,
        StringLength1: SQLSMALLINT,
        // _Out_writes_opt_(BufferLength)
    ...
    /// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, or SQL_INVALID_HANDLE.
    #[cfg(feature = "v3_8")]
    pub fn SQLCancelHandle(HandleType: HandleType, Handle: SQLHANDLE) -> SQLRETURN;
    ...
    pub fn SQLFreeHandle(HandleType: HandleType, Handle: SQLHANDLE) -> SQLRETURN;
    ...
    pub fn SQLGetDescFieldA(
        ...
        RecNumber: SQLSMALLINT,
        FieldIdentifier: DescFieldIdentifier,
        // _Out_writes_opt_(_Inexpressible_(BufferLength))
        ValuePtr: SQLPOINTER,
        BufferLength: SQLINTEGER,
        // _Out_opt_
    ...
    pub fn SQLRowCount(
        StatementHandle: SQLHSTMT,
        // _Out_
        RowCountPtr: *mut SQLLEN,
    ) -> SQLRETURN;

    #[link_name = "SQLSetConnectAttrA"]
    fn SetConnectAttrA(
        ConnectionHandle: SQLHDBC,
        Attribute: SQLINTEGER,
    ...
    pub fn SQLGetNestedHandle(
        ...
        Col_or_Param_Num: SQLUSMALLINT,
        // _Out_
        OutputChildStatementHandle: *mut SQLHSTMT,
    ) -> SQLRETURN;
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLGetConnectAttrA<ATTR: ConnAttr>(
    ConnectionHandle: SQLHDBC,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    BufferLength: SQLINTEGER,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NO_DATA, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLGetConnectAttrW<ATTR: ConnAttr>(
    ConnectionHandle: SQLHDBC,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    BufferLength: SQLINTEGER,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, or SQL_STILL_EXECUTING.
#[allow(non_snake_case)]
pub unsafe fn SQLSetConnectAttrA<ATTR: ConnAttr>(
    ConnectionHandle: SQLHDBC,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    StringLength: SQLINTEGER,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, or SQL_STILL_EXECUTING.
#[allow(non_snake_case)]
pub unsafe fn SQLSetConnectAttrW<ATTR: ConnAttr>(
    ConnectionHandle: SQLHDBC,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    StringLength: SQLINTEGER,
...
#[allow(non_snake_case)]
pub unsafe fn SQLGetDiagFieldA<ATTR: DiagIdentifier>(
    HandleType: HandleType,
    Handle: SQLHANDLE,
    RecNumber: SQLSMALLINT,
    DiagIdentifier: ATTR,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, SQL_INVALID_HANDLE, or SQL_NO_DATA.
#[allow(non_snake_case)]
pub unsafe fn SQLGetDiagFieldW<ATTR: DiagIdentifier>(
    HandleType: HandleType,
    Handle: SQLHANDLE,
    RecNumber: SQLSMALLINT,
    DiagIdentifier: ATTR,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLGetStmtAttrA<ATTR: StmtAttr>(
    StatementHandle: SQLHSTMT,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    BufferLength: SQLINTEGER,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLGetStmtAttrW<ATTR: StmtAttr>(
    StatementHandle: SQLHSTMT,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    BufferLength: SQLINTEGER,
    StringLengthPtr: Option<&mut SQLINTEGER>,
) -> SQLRETURN {
    GetStmtAttrW(
        StatementHandle,
        Attribute.raw_value(),
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLSetStmtAttrA<ATTR: StmtAttr>(
    StatementHandle: SQLHSTMT,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    StringLength: SQLINTEGER,
...
/// SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_ERROR, or SQL_INVALID_HANDLE.
#[allow(non_snake_case)]
pub unsafe fn SQLSetStmtAttrW<ATTR: StmtAttr>(
    StatementHandle: SQLHSTMT,
    Attribute: ATTR,
    ValuePtr: SQLPOINTER,
    StringLength: SQLINTEGER,
